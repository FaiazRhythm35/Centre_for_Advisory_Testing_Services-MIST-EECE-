...
SECRET_KEY = 'django-insecure-$fbdniwb@i8)1$0y!xx#7a^$b6zc8v*ox!hmq+-*59@2^se2q1'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# Development: allow all hosts to avoid preview/IDE host header issues
ALLOWED_HOSTS = ['*']
...
# Use absolute URL to avoid relative path issues on subroutes
STATIC_URL = '/static/'
...
# Email settings (persisted Gmail SMTP)
import os
